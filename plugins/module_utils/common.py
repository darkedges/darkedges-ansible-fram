...
# inspired by https://github.com/F5Networks/f5-ansible-bigip/blob/ee0d49f08ac0e7ecfc2cf2976d4d2d77a03e4a18/ansible_collections/f5networks/f5_bigip/plugins/module_utils/common.py


class ForgeRockModuleError(Exception):
    pass


class AnsibleForgeRockParameters:
